...
<head>
    ...
    <title>{{ config('SD NEGERI 1 BARENG MALANG', 'SD NEGERI 1 BARENG MALANG') }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('SD NEGERI 1 BARENG MALANG', 'SD NEGERI 1 BARENG MALANG') }}
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('menudata.index') }}">{{ __('Data') }}</a>
                            </li>
